                ...
                <div class="panel panel-default panel-fill">
                    ...
                    <div class="panel-body">
                        <form role="form">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="p-20 m-b-20">
                                            <h4 class="m-b-30 m-t-0 header-title">Sobre mí</h4>
                                            <div class="summernote">
                                                <h4>¡Hola!</h4>
                                                <ul>
                                                    <li>
                                                        Aquí podrás escribir sobre ti.
                                                    </li>
                                                    <li>
                            ...
                            <button class="btn btn-primary waves-effect waves-light w-md" type="submit">Actualizar información</button>
                        </form>
